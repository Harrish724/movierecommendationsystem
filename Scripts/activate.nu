...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\newproject\AJAX-Movie-Recommendation-System-with-Sentiment-Analysis'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\newproject\AJAX-Movie-Recommendation-System-with-Sentiment-Analysis\Scripts\deactivate.nu'
